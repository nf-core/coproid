//
// Subworkflow with functionality specific to the nf-core/coproid pipeline
//
...
\033[0;35m  nf-core/coproid ${workflow.manifest.version}\033[0m
-\033[2m----------------------------------------------------\033[0m-
"""
...
* Software dependencies
    https://github.com/nf-core/coproid/blob/master/CITATIONS.md
"""
    ...
    //
    channel.fromList(genomesToList(params.genome_sheet, "${projectDir}/assets/schema_genomes.json"))
        .map { meta, igenome, fasta, index ->
            [
